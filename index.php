	...
	<header id="home">
		...
		<div class="container">
			...
			<ul class="main-menu visible-on-click" id="main-menu">
				<li><a href="https://thamilevi.com.br">Home</a></li>
	...
	<footer id="contato">
		<div class="container center-text">
				...
				<div class="row">		
					<div class="col-sm-12">
						...
						<div class="margin-bottom">
							...
							<p>Cerimônia: <a href="https://goo.gl/maps/btigCVchgQeCUHq79" target="_blank" title="Local da Cerimônia">Rua Goiabas nº 2131 - Vargem Grande - Florianópolis/SC</a><br><small>Residência dos Noivos: Rua Álvaro Medeiros Santiago nº 1635, Bloco B, Apto. 405 - Areias - São José/SC</small></p>
			...
			<ul class="social-icons">
				<li><a href="https://www.instagram.com/thamiresoliveiraaoficial" title="Instagram da Noiva" target="_blank"><i class="icon icon-instagram"></i> @thamiresoliveiraaoficial</a></li>
				<li><a href="https://www.facebook.com/thamires.oliveira.737001" title="Facebook da Noiva" target="_blank"><i class="icon icon-facebook"></i> @thamires.oliveira.737001</a></li>
				<li><i class="icon icon-heart"></i></li>
				<li><a href="https://www.instagram.com/leviiandrew" title="Instagram do Noivo" target="_blank"><i class="icon icon-instagram"></i> @leviiandrew</a></li>
				<li><a href="https://www.facebook.com/leviaquino98" title="Facebook do Noivo" target="_blank"><i class="icon icon-facebook"></i> @leviaquino98</a></li>
			</ul>
			<hr>
